...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
    	...
    	Logger log = org.slf4j.LoggerFactory.getLogger(JwtFilter.class);
        	...
        	if(jwtToken == null) {
        		...
        		if(username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
        			...
        			if(userDetails != null && jwtService.isTokenValid(jwtToken, userDetails)) {
        				...
        				log.info("Authentication was set for {}",username);
        			}
        		}
        	}
        	
    	}catch(Exception e) {
    		log.error("Error occured during token extraction : {}",e.getMessage());
    	}
